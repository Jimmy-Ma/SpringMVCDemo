...
<script type="text/javascript">
	function queryItems(){
		//提交form
		document.intemsForm.action="${pageContext.request.contextPath }/items/queryItems.action";
		document.intemsForm.submit();
	}

	function delteItems(){
		//提交form
		document.intemsForm.action="${pageContext.request.contextPath }/items/deleteItems.action";
		document.intemsForm.submit();
	}
</script>
<title>查询商品列表</title>
	...
	<form name="intemsForm" action="${pageContext.request.contextPath }/items/queryItems.action"
		...
		<table width="100%" border=1>
			<tr>
				...
				<td><input type="button" value="批量删除" onclick="delteItems()"/></td>
			</tr>
		</table>
		商品列表：
		<table width="100%" border=1>
